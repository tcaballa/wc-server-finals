    ...
    <br><br>
       ...
       <form @submit.prevent = 'registerUser'>
        ...
        <div class ='form-group text-left'>
            ...
            <input type ='number' name='contact' id= 'contact' placeholder='Enter Contact No' v-model='contact' class='form-control'/>
...
.wholesign {
    height: 150vh;
    background-image: url('../assets/bglog2.jpg');
...
.col-lg-7 {
    ...
    margin: auto;
    -webkit-box-shadow: 10px 10px 33px 8px rgba(61,61,61,1);
    -moz-box-shadow: 10px 10px 33px 8px rgba(61,61,61,1);
    box-shadow: 10px 10px 33px 8px rgba(61,61,61,1);
